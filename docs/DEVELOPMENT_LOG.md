...
- Result fireworks now use deterministic round-seeded variation, giving each round a different spatial and timing pattern while remaining stable across rerenders.
